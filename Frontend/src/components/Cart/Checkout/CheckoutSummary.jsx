...
export const CheckoutSummary = () => {
  ...
  return (
    <section className="flex flex-col  justify-start items-start borderDark p-3 pt-0 rounded-xl mt-6 overflow-y-scroll max-h-[520px]">
      {
        cartItems.map((item, index) => {
          return (
           <article key={index} className="flex  justify-between gap-3 w-full  h-[160px] sm:h-[180px] lg:h-[180px] borderDark border-[.5px] border-opacity-15 border-x-0 border-t-0 last:border-none py-8  ">
